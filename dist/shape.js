...
export const LISTENING_SHAPE_PATH = fileURLToPath(new URL("../listening.shacl.ttl", import.meta.url));
/** Filesystem path to the federation-extension proposal candidates (`listening.proposals.ttl`). */
export const LISTENING_PROPOSALS_PATH = fileURLToPath(new URL("../listening.proposals.ttl", import.meta.url));
let cachedShape;
let cachedProposals;
/**
 ...
 */
export function listeningShapeTtl() {
    if (cachedShape === undefined)
        cachedShape = readFileSync(LISTENING_SHAPE_PATH, "utf8");
    return cachedShape;
}
/**
 ...
 */
export function listeningProposalsTtl() {
